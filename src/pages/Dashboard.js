...
import Statsummary from '../component/Statsummary';
            ...
            <div className="container-fluid" id="container-wrapper">
              ...
              <div className="row mb-3">
                <Statsummary 
                  ...
                  figure="$40,000" 
                  detailsiconstyle="text-success mr-2"
                  detailsicon="fa fa-arrow-up" 
                  details="3.48%" 
                  timer="Since last month" 
                  icon="fas fa-calendar fa-2x text-primary" />
                ...
                <Statsummary 
                  ...
                  details="12%" 
                  timer="Since last years" 
                  icon="fas fa-shopping-cart fa-2x text-success" />
                ...
                <Statsummary 
                  ...
                  details="20.4%" 
                  timer="Since last month" 
                  icon="fas fa-users fa-2x text-info" />

                <Statsummary 
                  title="Pending Requests" 
                  figure="18" 
                  detailsiconstyle="text-danger mr-2"
                  detailsicon="fas fa-arrow-down" 
                  details="1.10%" 
                  timer="Since yesterday" 
                  icon="fas fa-comments fa-2x text-warning" />
                  ...
                  <div className="card mb-4">
                    ...
                    <div className="card-body">
                      ...
                      <div className="mb-3">
                        ...
                        <div className="progress" style={{height:'12px'}}>
                          <div className="progress-bar bg-danger" role="progressbar" style={{width:'55%'}} aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>
                      <div className="mb-3">
          ...
          <footer className="sticky-footer bg-white">
            <div className="container my-auto">
              <div className="copyright text-center my-auto">
                <span>copyright &copy; 2023 - developed by <b>michael angelo mahinay</b></span>
              </div>
            </div>
          </footer>
        </div>
...
{/* 
      <script src={require('../assets/js/jquery/jquery.min.js')}></script>
      <script src={require('../assets/css/bootstrap/js/bootstrap.bundle.js')}></script>
      <script src={require('../assets/js/jquery-easing/jquery.easing.min.js')}></script>
      <script src={require('../assets/js/ruang-admin.js')}></script>
      <script src={require('../assets/js/chart.js/Chart.min.js')}></script>
      <script src={require('../assets/js/demo/chart-area-demo.js')}></script> */}
    </>
  );
}
